...
public class ConfigConstants {
    ...
    public static final String LRE_AUTHENTICATE_WITH_TOKEN = "authentication-point/authenticate/authenticateclient";
    ...
    public static final int MAX_WAIT_SECONDS = 1800;
